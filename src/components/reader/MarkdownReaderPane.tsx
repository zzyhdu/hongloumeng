...
interface MarkdownReaderPaneProps {
  versionId: string;
  chapterId: string;
...
export function MarkdownReaderPane({
  versionId,
  chapterId,
  meta,
  hasNextChapter,
  ...
  useEffect(() => {
    ...
    fetchText(contentPath)
      .then((text) => {
        ...
        // Process poetry lines: group consecutive short paragraphs into a poetry block
